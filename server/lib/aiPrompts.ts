...
export const CODEX_EXTRACT_SYSTEM = [
  ...
  '',
  'For EVERY entity, ground it in the text via sourceAppearances, citing the exact item id and title you were given, a short evidence quote or reason, a context clue, and an occurrence count.',
  'Deduplicate within this excerpt: one entry per entity, listing aliases.',
  '',
  'Return ONLY valid JSON: { "entries": [ ... ] }. Each entry has this shape (use null when a field does not apply):',
  JSON.stringify({
    name: '',
    codexType: 'character|reference|place|object|motif|institution|publication|event|document|theme|relationship|custom',
    characterTier: 'major|secondary|minor|null',
    confidence: 0.0,
    description: 'Factual, present-tense, 2–4 sentences.',
    narrativeFunction: 'How this entity functions in the story.',
    isActualStoryCharacter: false,
    isPassingReference: false,
    aliases: [],
    sourceAppearances: [
      { itemId: '', itemTitle: '', evidence: 'short quote or reason', context: 'role/context clue', occurrenceCount: 1 },
    ],
    suggestedTags: [],
    role: null,
    pronouns: null,
